...
mejorador_saturacion = ImageEnhance.Sharpness(normal_map_image)
normal_map_image = mejorador_saturacion.enhance(6)
mejorador_sharpness = ImageEnhance.Contrast(normal_map_image) #mirar como cambiar la altura del nnormal map. el contraste lo ahce azul >:(
normal_map_image = mejorador_sharpness.enhance(2.5).filter(ImageFilter.BoxBlur(7))
